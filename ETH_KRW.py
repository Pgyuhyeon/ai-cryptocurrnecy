...
while(1):
    ...
    book = {}
    response = requests.get ('https://api.bithumb.com/public/orderbook/ETH_KRW/?count=5') # 이더리움 api
    book = response.json()
    data = book['data']
    ...
    fn = "book-" + str(start_time.year) + "-" + str(start_time.month) + "-" + str(start_time.day) + "-bithumb-eth.csv"
